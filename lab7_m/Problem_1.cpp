...
void lb_litmus_test_sequential(int iteration, memory_order mem_order)
{
    X.store(0);
    Y.store(0);
...
void sb_litmus_test_sequential(int iteration, memory_order mem_order)
{
    X.store(0);
    Y.store(0);
...
void mp_litmus_test_sequential(int iteration, memory_order mem_order)
{
    X.store(0);
    Y.store(0);
...
void iriw_litmus_test_sequential(int iteration, memory_order mem_order)
{
    X.store(0);
    Y.store(0);
...
int main()
{
    memory_order mem_order = memory_order_seq_cst;

    for (int i = 0; i < 10000; ++i)
    {
        lb_litmus_test_sequential(i, mem_order);
    ...
    ofstream csv_file("Problem_1_Output.csv");
    ...
    for (int i = 0; i < 10000; ++i)
    {
        sb_litmus_test_sequential(i, mem_order);
    ...
    for (int i = 0; i < 10000; ++i)
    {
        mp_litmus_test_sequential(i, mem_order);
    ...
    for (int i = 0; i < 10000; ++i)
    {
        iriw_litmus_test_sequential(i, mem_order);
